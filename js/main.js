...
function displayIngrediants(theIngrediants) {
    ...
    for (let i = 0; i < theIngrediants.length; i++) {
        const description = theIngrediants[i].strDescription || ''; 
...
function displaySearch(){
    ...
    SearchingContainer.innerHTML = `
       <div class="row">
           <div class="col-md-6 ">
              <input type="text" onkeyup="searchByName(this.value)" class="form-control   bg-transparent  " placeholder="Search By Name" >  
           </div>
           <div class="col-md-6">
             <input type="text" onkeyup="searchByLetter(this.value)" class="  bg-transparent form-control  " placeholder="Search By First letter" maxlength="1" >  
           </div>
       <div>
